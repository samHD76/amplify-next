...
<div className=" mt-28 flex flex-col justify-center items-start   ">
    <h1 className="mt-10 md:mt-0 ml-10 text-[#e7c0ff] text-sm md:text-l">WELCOME TO </h1>
    <h1 className=" ml-10 mt-2 sm:text-2xl font-bold  text-[#ecd6fb]">{"My Crohn's and Colitis Angel"}</h1>

    <h1 className="ml-10 mt-14 sm:text-xl   text-[#ecd6fb]"> Empowering IBD Warriors Together</h1>

    <Link href={"../pages/signup"}>
        <button className="ml-10 mt-10 px-4 py-2 backdrop-blur-sm border bg-emerald-300/10 border-emerald-500/20 text-white mx-auto text-center rounded-full relative ">
          <span>Join us →</span>
...
<div className="bg-[#0b0326] flex w-full">
           <h1 className=" ml-10 mb-4   text-[#ecd6fb] font-bold">{"Join our supportive community to navigate life's challenges and triumphs with Crohn's and Colitis Angel"}</h1>
